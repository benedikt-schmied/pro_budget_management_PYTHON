...
class _test_bm_table_class(c_test_case):

    def __init__(self, _conn, _cursor):
        
        c_test_case.__init__(self, "class", self._test__push_into_class)
        self.bm_table_class = c_bm_table_class(_conn, _cursor)

    def _test__push_into_class(self):
        ''' 
        \brief test function for 
        push into matter of expenses
        '''
        self.bm_table_class._test_routines()
