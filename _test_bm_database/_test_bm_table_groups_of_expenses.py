...
class _test_bm_table_groups_of_expenses(c_test_case):

    def __init__(self, _conn, _cursor):
        
        c_test_case.__init__(self, "groups_of_expenses", self._test__push_into_groups_of_expenses)
        self.bm_table_groups_of_expenses = c_bm_table_groups_of_expenses(_conn, _cursor)

    def _test__push_into_groups_of_expenses(self):
        ''' 
        ...
        for entry in names:
            ...
            if self.bm_table_groups_of_expenses.push(
