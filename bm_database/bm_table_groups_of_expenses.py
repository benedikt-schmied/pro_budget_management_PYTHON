...
class c_bm_table_groups_of_expenses(c_bm_tables):
    ...
    def select_matching_id(self, _id):
        ...
        '''
        return t_bm_table_groups_of_expenses_l._make(self._select_matching_id(_id))
    ...
    def get_all(self):
        ...
        for row in self._get_all():
            entries.append(t_bm_table_groups_of_expenses_s._make(row))
        return entries
    ...
    def _test_routines(self):
        ...
        data = []
        data.append(t_bm_table_groups_of_expenses_s(name = "test"))
        data.append(t_bm_table_groups_of_expenses_s(name = "test1"))
        data.append(t_bm_table_groups_of_expenses_s(name = "test2"))
        data.append(t_bm_table_groups_of_expenses_s(name = "test3"))
